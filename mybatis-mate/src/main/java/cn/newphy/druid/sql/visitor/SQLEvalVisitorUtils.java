...
import cn.newphy.druid.sql.ast.expr.SQLValuableExpr;
...
import cn.newphy.druid.sql.dialect.db2.visitor.DB2EvalVisitor;
import cn.newphy.druid.sql.dialect.mysql.visitor.MySqlEvalVisitorImpl;
import cn.newphy.druid.sql.dialect.oracle.visitor.OracleEvalVisitor;
import cn.newphy.druid.sql.dialect.postgresql.visitor.PGEvalVisitor;
import cn.newphy.druid.sql.dialect.sqlserver.visitor.SQLServerEvalVisitor;
import cn.newphy.druid.sql.visitor.functions.Ascii;
import cn.newphy.druid.sql.visitor.functions.Bin;
import cn.newphy.druid.sql.visitor.functions.BitLength;
import cn.newphy.druid.sql.visitor.functions.Char;
import cn.newphy.druid.sql.visitor.functions.Concat;
import cn.newphy.druid.sql.visitor.functions.Function;
import cn.newphy.druid.sql.visitor.functions.Greatest;
import cn.newphy.druid.sql.visitor.functions.Hex;
import cn.newphy.druid.sql.visitor.functions.If;
import cn.newphy.druid.sql.visitor.functions.Insert;
import cn.newphy.druid.sql.visitor.functions.Instr;
import cn.newphy.druid.sql.visitor.functions.Lcase;
import cn.newphy.druid.sql.visitor.functions.Least;
import cn.newphy.druid.sql.visitor.functions.Left;
import cn.newphy.druid.sql.visitor.functions.Length;
import cn.newphy.druid.sql.visitor.functions.Locate;
import cn.newphy.druid.sql.visitor.functions.Lpad;
import cn.newphy.druid.sql.visitor.functions.Ltrim;
import cn.newphy.druid.sql.visitor.functions.Now;
import cn.newphy.druid.sql.visitor.functions.OneParamFunctions;
import cn.newphy.druid.sql.visitor.functions.Reverse;
import cn.newphy.druid.sql.visitor.functions.Right;
import cn.newphy.druid.sql.visitor.functions.Trim;
import cn.newphy.druid.sql.visitor.functions.Ucase;
import cn.newphy.druid.sql.visitor.functions.Unhex;
import cn.newphy.druid.util.HexBin;
import cn.newphy.druid.util.JdbcConstants;
import cn.newphy.druid.util.JdbcUtils;
import cn.newphy.druid.util.Utils;
...
import cn.newphy.druid.sql.visitor.functions.Elt;
import cn.newphy.druid.sql.visitor.functions.Isnull;
import cn.newphy.druid.sql.visitor.functions.Substring;
        ...
        for (SQLCaseExpr.Item item : x.getItems()) {
            ...
            if ((x.getValueExpr() != null && eq(value, conditionValue))
                ...
                if (item.getValueExpr().getAttributes().containsKey(SQLEvalVisitor.EVAL_VALUE)) {
                    x.getAttributes().put(
                        SQLEvalVisitor.EVAL_VALUE, item.getValueExpr().getAttribute(SQLEvalVisitor.EVAL_VALUE));
                }
