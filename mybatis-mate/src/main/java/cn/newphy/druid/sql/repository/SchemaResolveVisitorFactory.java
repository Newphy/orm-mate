 ...
 */
package cn.newphy.druid.sql.repository;
...
import cn.newphy.druid.sql.ast.statement.SQLForeignKeyConstraint;
...
import cn.newphy.druid.sql.ast.statement.SQLTableElement;
import cn.newphy.druid.sql.ast.statement.SQLTableSource;
import cn.newphy.druid.sql.ast.statement.SQLUniqueConstraint;
...
import cn.newphy.druid.sql.dialect.db2.visitor.DB2ASTVisitorAdapter;
import cn.newphy.druid.sql.dialect.hive.ast.HiveMultiInsertStatement;
import cn.newphy.druid.sql.dialect.hive.visitor.HiveASTVisitorAdapter;
...
import cn.newphy.druid.sql.dialect.postgresql.visitor.PGASTVisitorAdapter;
import cn.newphy.druid.sql.dialect.sqlserver.ast.SQLServerSelectQueryBlock;
import cn.newphy.druid.sql.dialect.sqlserver.ast.stmt.SQLServerUpdateStatement;
import cn.newphy.druid.sql.dialect.sqlserver.visitor.SQLServerASTVisitorAdapter;
...
import cn.newphy.druid.sql.dialect.db2.ast.DB2Object;
...
import cn.newphy.druid.sql.dialect.odps.visitor.OdpsASTVisitorAdapter;
...
import cn.newphy.druid.sql.dialect.sqlserver.ast.stmt.SQLServerInsertStatement;
...
class SchemaResolveVisitorFactory {
    static class MySqlResolveVisitor extends MySqlASTVisitorAdapter implements SchemaResolveVisitor {
        ...
        @Override public boolean visit(MySqlSelectQueryBlock x) {
            resolve(this, x);
            return false;
        }

        @Override public boolean visit(SQLSelectQueryBlock x) {
            resolve(this, x);
            return false;
        }

        @Override public boolean visit(SQLSelectItem x) {
        ...
        @Override public boolean visit(SQLPropertyExpr x) {
            resolve(this, x);
            return false;
        }

        @Override public boolean visit(SQLAllColumnExpr x) {
            resolve(this, x);
            return false;
        }

        @Override public boolean visit(MySqlCreateTableStatement x) {
            resolve(this, x);
        ...
        @Override public boolean visit(SQLSelect x) {
            resolve(this, x);
            return false;
        }
        ...
        @Override public boolean visit(SQLReplaceStatement x) {
            resolve(this, x);
            return false;
        }
    ...
    static class DB2ResolveVisitor extends DB2ASTVisitorAdapter implements SchemaResolveVisitor {
        ...
        @Override public boolean visit(DB2SelectQueryBlock x) {
            resolve(this, x);
            return false;
        }
        ...
        @Override public boolean visit(SQLCreateTableStatement x) {
            resolve(this, x);
            return false;
        }

        @Override public boolean visit(SQLUpdateStatement x) {
            resolve(this, x);
            return false;
        }

        @Override public boolean visit(SQLDeleteStatement x) {
            resolve(this, x);
            return false;
        }
    ...
    static class OracleResolveVisitor extends OracleASTVisitorAdapter implements SchemaResolveVisitor {
        ...
        @Override public boolean visit(OracleCreatePackageStatement x) {
        ...
        @Override public boolean visit(OracleForStatement x) {
            Context ctx = createContext(x);
        ...
        @Override public boolean visit(OracleForeignKey x) {
            resolve(this, x);
            return false;
        }
        ...
        @Override public boolean visit(OracleSelectTableReference x) {
            resolve(this, x);
            return false;
        }
        ...
        @Override public boolean visit(OracleSelectQueryBlock x) {
            resolve(this, x);
            return false;
        }
        ...
        @Override public boolean visit(OracleCreateTableStatement x) {
            resolve(this, x);
            return false;
        }
        ...
        @Override public boolean visit(OracleUpdateStatement x) {
            resolve(this, x);
            return false;
        }
        ...
        @Override public boolean visit(OracleDeleteStatement x) {
            resolve(this, x);
            return false;
        }
        ...
        @Override public boolean visit(OracleMultiInsertStatement x) {
            Context ctx = createContext(x);
        ...
        @Override public boolean visit(OracleMultiInsertStatement.InsertIntoClause x) {
        ...
        @Override public boolean visit(OracleInsertStatement x) {
            resolve(this, x);
            return false;
        }
    ...
    static class OdpsResolveVisitor extends OdpsASTVisitorAdapter implements SchemaResolveVisitor {
        ...
        @Override public boolean visit(OdpsSelectQueryBlock x) {
            resolve(this, x);
            return false;
        }
        ...
        @Override public boolean visit(OdpsCreateTableStatement x) {
            resolve(this, x);
            return false;
        }
        ...
        @Override public boolean visit(HiveInsert x) {
            Context ctx = createContext(x);
    ...
    static class PGResolveVisitor extends PGASTVisitorAdapter implements SchemaResolveVisitor {
        ...
        @Override public boolean visit(PGSelectQueryBlock x) {
            resolve(this, x);
            return false;
        }

        @Override public boolean visit(PGFunctionTableSource x) {
        ...
        @Override public boolean visit(PGUpdateStatement x) {
            resolve(this, x);
            return false;
        }
        ...
        @Override public boolean visit(PGDeleteStatement x) {
            resolve(this, x);
            return false;
        }

        @Override public boolean visit(PGSelectStatement x) {
            createContext(x);
            visit(x.getSelect());
            popContext();
            return false;
        ...
        @Override public boolean visit(PGInsertStatement x) {
            resolve(this, x);
            return false;
        }
    ...
    static class SQLServerResolveVisitor extends SQLServerASTVisitorAdapter implements SchemaResolveVisitor {
        ...
        @Override public boolean visit(SQLServerUpdateStatement x) {
            resolve(this, x);
            return false;
        }
        ...
        @Override public boolean visit(SQLServerInsertStatement x) {
            resolve(this, x);
            return false;
        }
