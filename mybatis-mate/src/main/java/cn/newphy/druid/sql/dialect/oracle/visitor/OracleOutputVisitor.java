 ...
 */
package cn.newphy.druid.sql.dialect.oracle.visitor;
...
import cn.newphy.druid.sql.ast.SQLHint;
...
import cn.newphy.druid.sql.ast.SQLPartitionBy;
...
import cn.newphy.druid.sql.ast.statement.SQLAlterTableItem;
...
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleAnalytic;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleAnalyticWindowing;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleArgumentExpr;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleBinaryDoubleExpr;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleBinaryFloatExpr;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleCursorExpr;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleDatetimeExpr;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleDbLinkExpr;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleIntervalExpr;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleIsOfTypeExpr;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleIsSetExpr;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleOuterExpr;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleRangeExpr;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleSizeExpr;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleSysdateExpr;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.OracleTreatExpr;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterSessionStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterSynonymStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableDropPartition;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableModify;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableMoveTablespace;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableTruncatePartition;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterTablespaceAddDataFile;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterTablespaceStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterTriggerStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterViewStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleCheck;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleConstraint;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleContinueStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleCreateDatabaseDbLinkStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleCreateIndexStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleCreatePackageStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleCreateSynonymStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleCreateTableStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleCreateTypeStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleDeleteStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleDropDbLinkStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleExceptionStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleExecuteImmediateStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleExitStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleExplainStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleFileSpecification;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleForStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleForeignKey;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleGotoStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleInsertStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleLabelStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleLockTableStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OraclePipeRowStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OraclePrimaryKey;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleRaiseStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleRunStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleSelectJoin;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleSelectPivot;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleSelectPivotBase;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleSelectQueryBlock;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleSelectRestriction;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleSelectSubqueryTableSource;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleSelectTableReference;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleSelectUnPivot;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleSetTransactionStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleSupplementalIdKey;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleSupplementalLogGrp;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleUnique;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleUpdateStatement;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleUsingIndexClause;
import cn.newphy.druid.sql.dialect.oracle.parser.OracleFunctionDataType;
import java.util.List;

import cn.newphy.druid.sql.ast.*;
import cn.newphy.druid.sql.ast.expr.*;
import cn.newphy.druid.sql.ast.statement.*;
import cn.newphy.druid.sql.ast.statement.SQLJoinTableSource.JoinType;
import cn.newphy.druid.sql.dialect.oracle.ast.OracleDataTypeIntervalDay;
import cn.newphy.druid.sql.dialect.oracle.ast.OracleDataTypeIntervalYear;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.CycleClause;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.ModelClause;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.ModelClause.CellAssignment;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.ModelClause.CellAssignmentItem;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.ModelClause.CellReferenceOption;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.ModelClause.MainModelClause;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelColumn;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelColumnClause;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelRuleOption;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.ModelClause.ModelRulesClause;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.ModelClause.QueryPartitionClause;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.ModelClause.ReferenceModelClause;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.ModelClause.ReturnRowsClause;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.OracleLobStorageClause;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.OracleReturningClause;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.OracleStorageClause;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.OracleWithSubqueryEntry;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.PartitionExtensionClause;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.SampleClause;
import cn.newphy.druid.sql.dialect.oracle.ast.clause.SearchClause;
import cn.newphy.druid.sql.dialect.oracle.ast.expr.*;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.*;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement.Rebuild;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.NestedTablePartitionSpec;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.TableSpaceItem;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.UpdateIndexesClause;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClause;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClauseItem;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.InsertIntoClause;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleSelectPivot.Item;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.CheckOption;
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.ReadOnly;
import cn.newphy.druid.sql.dialect.oracle.parser.OracleProcedureDataType;
