 ...
 */
package cn.newphy.druid.sql.dialect.oracle.parser;

import cn.newphy.druid.sql.ast.SQLArgument;
import cn.newphy.druid.sql.ast.SQLDataType;
import cn.newphy.druid.sql.ast.SQLDataTypeImpl;
...
import cn.newphy.druid.sql.ast.statement.SQLInsertInto;
...
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleStatement;
import cn.newphy.druid.sql.parser.LayoutCharacters;
...
import cn.newphy.druid.sql.dialect.oracle.ast.stmt.OracleLockTableStatement.LockMode;
            ...
            if (lexer.token() == Token.VARIANT) {
                ...
                if (variant instanceof SQLBinaryOpExpr) {
                    ...
                    if (binaryOpExpr.getOperator() == SQLBinaryOperator.Assignment) {
                        SQLSetStatement
                            stmt = new SQLSetStatement(binaryOpExpr.getLeft(), binaryOpExpr.getRight(), getDbType());
                        stmt.setParent(parent);
                        statementList.add(stmt);
                        continue;
                    }
