...
public interface OdpsASTVisitor extends SQLASTVisitor {
    ...
    void endVisit(TableCount x);
    
    boolean visit(TableCount x);
    
    void endVisit(ExpressionCondition x);
    
    boolean visit(ExpressionCondition x);
    
    void endVisit(NullValue x);
    
    boolean visit(NullValue x);
    
    void endVisit(ColumnSum x);
    
    boolean visit(ColumnSum x);
    
    void endVisit(ColumnMax x);
    
    boolean visit(ColumnMax x);
    
    void endVisit(ColumnMin x);
    
    boolean visit(ColumnMin x);
