...
import cn.newphy.druid.sql.ast.SQLObjectImpl;
import cn.newphy.druid.sql.ast.SQLObjectWithDataType;
...
public class SQLColumnDefinition extends SQLObjectImpl
    implements SQLTableElement, SQLObjectWithDataType, SQLReplaceable {
