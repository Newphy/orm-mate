...
public class TotalPage<T> extends ArrayList<T> implements Page<T> {
	...
	public String toString() {
		...
		return String.format("TotalPage[totalPage=%d, pageNumber=%d, total=%d，pageCount=%d, type=%s]",
				getTotalPages(), getPageNumber(), getTotalElements(), getNumberOfElements(), contentType);
	}
